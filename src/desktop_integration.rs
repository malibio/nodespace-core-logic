...
/// Enhanced query response for desktop app integration
...
/// Rich source information with metadata
#[derive(Debug, Clone, Serialize, Deserialize)]
...
impl<D: DataStore + Send + Sync, N: NLPEngine + Send + Sync> NodeSpaceService<D, N> {
    ...
    /// Enhanced query processing with rich metadata
